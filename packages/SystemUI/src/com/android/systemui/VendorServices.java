...
public class VendorServices extends CoreStartable { 
    ...
    private SmartPixelsReceiver mSmartPixelsReceiver;    
        @Inject
    public VendorServices(Context context, SmartPixelsReceiver smartPixelsReceiver, AlarmManager alarmManager, AssistManager assistManager, CentralSurfaces centralSurfaces) {
        super(context);
